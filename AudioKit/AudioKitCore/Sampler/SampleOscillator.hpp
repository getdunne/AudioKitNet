...
namespace AudioKitCore
{
    ...
    struct SampleOscillator
    {
        ...
        inline bool getSample(SampleBuffer* sampleBuffer, float* output, float gain)
        {
        ...
        // return true if we run out of samples
        inline bool getSamplePair(SampleBuffer* sampleBuffer, float* leftOutput, float* rightOutput, float gain)
        {
            if (sampleBuffer == NULL || indexPoint > sampleBuffer->endPoint) return true;
