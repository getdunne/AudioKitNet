...
namespace AudioKitCore
{
    ...
    // based on up to 6 simultaneous waveform-readout "phases" differing slightly in frequency
    ...
    struct EnsembleOscillator
    {
        ...
        // per-phase variables
        static constexpr int maxPhases = 7; // more than 6 phases doesn't sound different
